...
<script src="/js/admin/bootstrap-transition.js"></script>

<!-- alert enhancer library -->
<script src="/js/admin/bootstrap-alert.js"></script>

<!-- modal / dialog library -->
<script src="/js/admin/bootstrap-modal.js"></script>

<!-- custom dropdown library -->
<script src="/js/admin/bootstrap-dropdown.js"></script>

<!-- scrolspy library -->
<script src="/js/admin/bootstrap-scrollspy.js"></script>

<!-- library for creating tabs -->
<script src="/js/admin/bootstrap-tab.js"></script>

<!-- library for advanced tooltip -->
<script src="/js/admin/bootstrap-tooltip.js"></script>

<!-- popover effect library -->
<script src="/js/admin/bootstrap-popover.js"></script>
<!-- button enhancer library -->
<script src="/js/admin/bootstrap-button.js"></script>
<!-- accordion library (optional, not used in demo) -->
<script src="/js/admin/bootstrap-collapse.js"></script>
<!-- carousel slideshow library (optional, not used in demo) -->
<script src="/js/admin/bootstrap-carousel.js"></script>
<!-- autocomplete library -->
<script src="/js/admin/bootstrap-typeahead.js"></script>
<!-- tour library -->
<script src="/js/admin/bootstrap-tour.js"></script>
...
<script src="/js/admin/jquery.autogrow-textarea.js"></script>
<!-- multiple file upload plugin -->
<script src="/js/admin/jquery.uploadify-3.1.min.js"></script>
<!-- history.js for cross-browser state change on ajax -->
<script src="/js/admin/jquery.history.js"></script>
